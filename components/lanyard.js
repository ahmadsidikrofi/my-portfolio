...
const cardGLB_URL = "/card.glb";
const lanyardTexture_URL = "/lanyard.png";
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  // Menggunakan URL untuk memuat model dan tekstur
  const { nodes, materials } = useGLTF(cardGLB_URL);
  const texture = useTexture(lanyardTexture_URL);
