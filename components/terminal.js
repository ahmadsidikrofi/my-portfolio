...
const Terminal = ({ 
    ...
    return (
        // h-[calc(100vh-4rem)]
        <div className="w-full lg:w-4/5 flex flex-col border-green-500">
            {/* Navigation */}
            <nav className="mb-4">
                    ...
                    {[
                        ...
                        <div key={item}>
                            <button
                                ...
                                className={`hover:text-white transition-colors focus:outline-none ${activeSection === item ? "text-white" : "text-[#39FF14]"
                                    }`}
                            >
                                {item}
                            </button>
            ...
            {/* Terminal Content */}
            <ScrollArea ref={terminalRef} className="flex-1 overflow-y-auto pr-2" onClick={focusInput}>
